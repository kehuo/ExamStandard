...
import { Row, Col, Input, Select, Icon, Table, Tooltip, message, Button, Tabs, Popconfirm } from 'antd';
...
export default class EmrResource extends React.Component {
	...
	buildOpBar() {
		...
		return (
			<Row style={{marginTop:10, marginBottom:10}}>
				...
				<Col span={4} offset={1}>
					<Button type="primary" onClick={this.onShowNewPopup.bind(this, null)}>新建病历数据</Button>
				</Col>
			</Row>
		);
	}
	...
	render() {
		...
		const columns = [
			{dataIndex:'name', title:'标记', render: this.textRender.bind(this, 16)},
			{dataIndex:'description', title:'描述', render: this.textRender.bind(this, 32)},
		...
		return (
			<div style={{width:1000, margin:'auto', backgroundColor:'white', padding:20}}>
				...
				<Table size="small"
				    ...
				    pagination={pageOpts}
				/>
				<EmrResourcePopup visible={showPopup}
				                  item={hotOne}
