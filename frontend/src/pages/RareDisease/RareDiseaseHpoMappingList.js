...
export default class CnRareDiseaseMappingList extends React.Component {
	...
	render() {
		...
		const columns = [
			...
			{dataIndex:'rareDisabled', title:'罕见病状态', render: this.statusRender.bind(this)},
			{dataIndex:'hpoCnName', title:'HPO', render: this.longTextRender.bind(this, 20, 'hpoEnName')},
			{dataIndex:'hpoCode', title:'HPO编码'},
			{dataIndex:'hpoDisabled', title:'HPO状态', render: this.statusRender.bind(this)},
		...
		return (
			<div style={{width:1000, margin:'auto', backgroundColor:'white', padding:20}}>
				...
				<Table columns={columns}
				       ...
				       pagination={pageOpts}
				/>
				<RareDiseaseHpoMappingPopup visible={showMappingPopup}
				                           item={hotItem}
