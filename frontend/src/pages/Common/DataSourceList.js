...
export default class DataSourceList extends React.Component {
	...
	buildOpBar() {
		...
		return (
			<Row style={{marginTop:10, marginBottom:10}}>
				...
				<Col span={4} offset={1}>
					<Button type="primary" onClick={this.onShowNewPopup.bind(this, null)}>新建数据源</Button>
				</Col>
			</Row>
		);
	}
	...
	render() {
		...
		const columns = [
			...
			{dataIndex:'source_type', title:'类型', render: this.typeRender.bind(this)},
		...
		return (
			<div style={{width:1000, margin:'auto', backgroundColor:'white', padding:20}}>
				...
				<Table columns={columns}
				       ...
				       pagination={pageOpts}
				/>
				<DataSourcePopup visible={showPopup}
				                 item={hotOne}
