...
export default class ModelVDMappingList extends React.Component {
	...
	buildOpBar() {
		...
		return (
			<Row style={{marginTop:10, marginBottom:10}}>
				...
				<Col span={4} offset={1}>
					<Button type="primary" onClick={this.onShowNewPopup.bind(this, null)}>新建模型配置</Button>
				</Col>
			</Row>
		);
	}
	...
	render() {
		const { data, total, virtualDepartments, models } = this.props.modelVDMapping;
		...
		return (
			<div style={{width:1000, margin:'auto', backgroundColor:'white', padding:20}}>
				...
				<Table columns={columns}
				       ...
				       pagination={pageOpts}
				/>
				<ModelVDMappingPopup visible={showPopup}
				                    item={hotOne}
