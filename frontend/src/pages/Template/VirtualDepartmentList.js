...
export default class VirtualDepartmentList extends React.Component {
	...
	buildOpBar() {
		...
		return (
			<Row style={{marginTop:10, marginBottom:10}}>
				...
				<Col span={4} offset={1}>
					<Button type="primary" onClick={this.onShowNewPopup.bind(this, null)}>新建虚拟组</Button>
				</Col>
			</Row>
		);
	}
	...
	render() {
		const { data, total, departmentOptions, userOptions } = this.props.virtualDepartment;
		...
		return (
			<div style={{width:1000, margin:'auto', backgroundColor:'white', padding:20}}>
				...
				<Table columns={columns}
				       ...
				       pagination={pageOpts}
				/>
				<VirtualDepartmentPopup visible={showPopup}
				               item={hotOneId}
