...
export default class InterfaceList extends React.Component {
	...
	buildOpBar() {
		...
		return (
			<Row style={{marginTop:10, marginBottom:10}}>
				...
				<Col span={4} offset={1}>
					<Button type="primary" onClick={this.onShowNewPopup.bind(this, null)}>新建接口</Button>
				</Col>
			</Row>
		);
	}
	...
	render() {
		...
		const columns = [
			...
			{dataIndex:'module_name', title:'模块名', render: this.longTextRender.bind(this)},
		...
		return (
			<div style={{width:1000, margin:'auto', backgroundColor:'white', padding:20}}>
				...
				<Table columns={columns}
				       ...
				       pagination={pageOpts}
				/>
				<InterfacePopup visible={showPopup}
				          item={hotOne}
