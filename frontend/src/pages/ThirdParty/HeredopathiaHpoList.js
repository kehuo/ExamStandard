...
export default class HeredopathiaHpoList extends React.Component {
	...
	buildOpBar() {
		...
		return (
			<Row style={{marginTop:10, marginBottom:10}}>
				...
				<Col span={4} offset={1}>
					<Button type="primary" onClick={this.onShowNewPopup.bind(this, null)}>新建遗传病项</Button>
				</Col>
        <Col span={4} offset={1}>
          <ImpHeredopathiaHpos/>
        </Col>
	...
	render() {
		...
		const columns = [
			{dataIndex:'phenotype', title:'表型', render: this.longTextRender.bind(this)},
			{dataIndex:'phenotype_cn', title:'表型名称', render: this.longTextRender.bind(this)},
		...
		return (
			<div style={{width:1000, margin:'auto', backgroundColor:'white', padding:20}}>
				...
				<Table columns={columns}
				       ...
				       pagination={pageOpts}
				/>
				<HeredopathiaHpoPopup visible={showPopup}
				          item={hotOne}
