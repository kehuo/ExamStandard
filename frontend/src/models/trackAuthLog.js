import { getTrackAuthLogList, getTrackAuthLogOne, getTrackAuthLogCompare } from '@/services/trackAuthLogOps';
...
export default {
	...
	effects: {
		*init({payload, callback}, {call, put}) {
			const response0 = yield call(getOrganizationList, {page:1, pageSize:1000});
